...
from omniisaacgymenvs.robots.articulations.movable_inspire_R_vertical import MovableInspireHandR
from omniisaacgymenvs.robots.articulations.views.movable_inspire_R_view_vertical import MovableInspireRView

from omniisaacgymenvs.tasks.shared.vertical_grasp_basic import VerticalGraspBasicTask
...
class VerticalGraspTask(VerticalGraspBasicTask):
    def __init__(
        self, 
        name, 
        ...
        VerticalGraspBasicTask.__init__(self, name=name, env=env)
